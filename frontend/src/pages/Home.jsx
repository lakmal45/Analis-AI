...
const Home = () => {
  ...
  const [counters, setCounters] = useState({ users: 0, signals: 0, accuracy: 0 });
  ...
  useEffect(() => {
    const targets = { users: 12500, signals: 48000, accuracy: 94 };
    const duration = 2000;
    const steps = 60;
    ...
    const timer = setInterval(() => {
      ...
      setCounters({
        ...
        signals: Math.floor(targets.signals * ease),
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a] text-white overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] rounded-full bg-violet-600/[0.07] blur-[120px] animate-pulse" style={{ animationDelay: "1s" }} />
        <div className="absolute top-[40%] left-[50%] w-[400px] h-[400px] rounded-full bg-cyan-500/[0.05] blur-[100px] animate-pulse" style={{ animationDelay: "2s" }} />
      </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              Harness the power of artificial intelligence to analyze crypto markets in real-time.
              Get actionable signals, manage your portfolio, and stay ahead of the market.
            </p>
            ...
            <div className="relative rounded-2xl border border-white/[0.08] bg-gradient-to-b from-white/[0.04] to-transparent p-1 shadow-2xl shadow-black/40">
              <div className="rounded-xl bg-[#0d1225] p-4 md:p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="ml-3 text-xs text-gray-500">AnalisAI Dashboard</span>
                </div>
                <div className="grid grid-cols-3 gap-3 mb-4">
                  {[
                    { label: "BTC/USDT", value: "$67,842", change: "+2.4%", up: true },
                    { label: "ETH/USDT", value: "$3,521", change: "+1.8%", up: true },
                    { label: "SOL/USDT", value: "$142.30", change: "-0.6%", up: false },
                  ].map((c) => (
                    <div key={c.label} className="rounded-lg bg-white/[0.03] border border-white/[0.06] p-3">
                      ...
                      <div className={`text-xs font-medium ${c.up ? "text-emerald-400" : "text-red-400"}`}>
                        {c.change}
                      </div>
                    </div>
                  ))}
      ...
      <section className="relative z-10 px-6 md:px-12 lg:px-20 py-16">
        <div className="max-w-4xl mx-auto grid grid-cols-3 gap-6">
          {[
            { label: "Active Traders", value: counters.users.toLocaleString() + "+" },
            { label: "Signals Generated", value: counters.signals.toLocaleString() + "+" },
            { label: "Accuracy Rate", value: counters.accuracy + "%" },
          ].map((s) => (
            <div key={s.label} className="text-center p-6 rounded-2xl bg-white/[0.02] border border-white/[0.06] backdrop-blur-sm hover:bg-white/[0.04] hover:border-white/[0.12] transition-all">
              <div className="text-2xl md:text-4xl font-extrabold bg-gradient-to-r from-blue-400 to-violet-400 bg-clip-text text-transparent mb-1">
                {s.value}
              </div>
      ...
      {/* Features */}
      <section id="features" className="relative z-10 px-6 md:px-12 lg:px-20 py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-xl mx-auto">
              Our platform combines cutting-edge AI with real-time data to give you an unfair advantage.
            </p>
          </div>
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <div className="p-10 md:p-14 rounded-3xl border border-white/[0.08] bg-white/[0.02] backdrop-blur-sm">
            ...
            <p className="text-gray-400 mb-8 max-w-lg mx-auto">
              Join thousands of traders who are already using AnalisAI to make data-driven decisions.
            </p>
            <Link
              to={user ? "/app/dashboard" : "/register"}
