...
const BacktestRunSchema = new mongoose.Schema({
  ...
  config: {
    ...
    tradeAmountUsd: { type: Number, default: 10 },
    atrTargetMultiplier: { type: Number, default: 3 },
    atrStopMultiplier: { type: Number, default: 1.5 },
    startDate: { type: Date, default: null },
    endDate: { type: Date, default: null },
    mlModel: { type: String, default: "off" },
    mlEnabled: { type: Boolean, default: false },
    applyAccuracyGuardrails: { type: Boolean, default: false },
    feesPerTradePct: { type: Number, default: 0.04 },
    intrabarPolicy: {
      type: String,
  ...
  summary: {
    ...
    avgPnlUsd: { type: Number, default: 0 },
    bestTradePnlUsd: { type: Number, default: 0 },
    worstTradePnlUsd: { type: Number, default: 0 },
