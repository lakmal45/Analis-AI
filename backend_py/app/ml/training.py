...
def evaluate_promotion_eligibility(metrics: dict[str, Any]) -> dict[str, Any]:
    min_dataset_rows = settings.ml_promotion_min_dataset_rows
    min_roc_auc = settings.ml_promotion_min_roc_auc
    min_walkforward_roc_auc = settings.ml_promotion_min_walkforward_roc_auc
    max_brier_score = settings.ml_promotion_max_brier_score
